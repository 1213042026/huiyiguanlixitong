...
public class Menu implements Serializable {
	...
	public static Menu[] GetMenu(int roleID) {
		...
		if (roleID == 0) {
			...
			linkList = new Link[3];
			linkList[0] = new Link("Main/MeetingManage/meetingapply_first.jsp",
					"预约会议");
			linkList[1] = new Link("Main/MeetingManage/applicationquery.jsp",
					"查询预约");
			linkList[2] = new Link("Main/MeetingManage/meetingquery.jsp",
					"查询会议");
			...
			linkList = new Link[2];
			linkList[0] = new Link("Main/MeetingManage/meetingcheck.jsp",
					"审批预约");
			linkList[1] = new Link("Main/MeetingManage/meetingquery.jsp",
					"查询会议");
			menu[0] = new Menu("会议管理", linkList);
